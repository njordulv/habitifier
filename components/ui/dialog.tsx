...
const DialogHeader = ({
  ...
  <div
    className={cn('flex flex-col space-y-1.5 text-left px-4', className)}
    {...props}
  />
)
...
const DialogFooter = ({
  ...
  <div
    className={cn('flex flex-row justify-start space-x-2 px-4', className)}
    {...props}
  />
)
